...
##################################################
# running CMPLX_DIV_approx function
##################################################

# initiating simulation
N = 20#2*rand.randint(5,10)
...
plt.title('REAL DIV_approx operation with N=%d, p=%d' %(N,p))

plt.figure(3)
plt.plot(out_arr_Im,exp_arr_Im, 'bo', ms=1)
plt.xlabel('out results')
plt.ylabel('expected results')
plt.title('IMAGINARY DIV_approx operation with N=%d, p=%d' %(N,p))
